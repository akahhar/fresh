...
class PayrollUkApi
{
    ...
    protected function getEmployeesRequest($xero_tenant_id, $first_name = null, $last_name = null, $page = null)
    {
        ...
        // query params
        if ($first_name !== null) {
            $queryParams['firstName'] = PayrollUkObjectSerializer::toQueryValue($first_name);
        }
        // query params
        if ($last_name !== null) {
            $queryParams['lastName'] = PayrollUkObjectSerializer::toQueryValue($last_name);
        }
        // query params
        if ($page !== null) {
            $queryParams['page'] = PayrollUkObjectSerializer::toQueryValue($page);
    ...
    protected function getTimesheetsRequest($xero_tenant_id, $page = null, $employee_id = null, $payroll_calendar_id = null)
    {
        ...
        // query params
        if ($employee_id !== null) {
            $queryParams['employeeId'] = PayrollUkObjectSerializer::toQueryValue($employee_id);
        }
        // query params
        if ($payroll_calendar_id !== null) {
            $queryParams['payrollCalendarId'] = PayrollUkObjectSerializer::toQueryValue($payroll_calendar_id);
        }
        // header params
        if ($xero_tenant_id !== null) {
            $headerParams['Xero-Tenant-Id'] = PayrollUkObjectSerializer::toHeaderValue($xero_tenant_id);
