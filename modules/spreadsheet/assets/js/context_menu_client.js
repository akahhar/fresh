        ...
        switch (moveToAlbumSelectedId) {
            case 'edit':
                ...
                if (type == 'file') {
                    ...
                    if (share == false) {
                        ...
                        $.get(admin_url + 'spreadsheet/get_hash_staff/' + id_set).done(function (response) {
            ...
            case 'share':
                ...
                if (id_set != '') {
                    ...
                    $.get(admin_url + 'spreadsheet/get_my_folder/' + id_set).done(function (response) {
                        response = JSON.parse(response);
                            ...
                            if (response.client_groups_share || response.clients_share) {
                                ...
                                $.each(clients_share, function (index, value) {
                                    if (index > 0) {
                                        ...
                                        $.get(admin_url + 'spreadsheet/get_my_folder_get_hash/client/' + value + '/' + id_set).done(function (response_client) {
                            ...
                            if (response.departments_share || response.staffs_share) {
                                ...
                                $.each(staffs_share, function (index, value) {
                                    if (index > 0) {
                                        ...
                                        $.get(admin_url + 'spreadsheet/get_my_folder_get_hash/staff/' + value + '/' + id_set).done(function (response_staff) {
            ...
            case "d_zip":
                ...
                $.get(admin_url + 'spreadsheet/get_folder_zip/' + id_set + '/' + nameCleaned).done(function (response) {
                    response = JSON.parse(response);
                })
                break;
            case "d_file":
                $.get(admin_url + 'spreadsheet/spreadsheet_client/get_file_sheet/' + id_set).done(function (response) {
                    response = JSON.parse(response);
            ...
            default:
                if (type == 'file') {
                    if (share == false) {
                        ...
                        $.get(site_url + 'spreadsheet/spreadsheet_client/get_hash_client/' + id_set).done(function (response) {
                            response = JSON.parse(response);
                            window.location.replace(site_url + 'spreadsheet/spreadsheet_client/file_view_share/' + response.hash);
                        })
                    }
                } else {
                    $('#AddFolderModal .add-new').addClass('hide');
