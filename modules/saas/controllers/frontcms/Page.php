...
class Page extends Gb_Controller
{
    ...
    public function save_pages($id = null)
    {
        ...
        if (!empty($created) || !empty($edited) && !empty($id)) {
            $this->cms_menu_model->_table_name = 'tbl_saas_front_pages';
            $this->cms_menu_model->_primary_key = 'pages_id';
            $data = $this->cms_menu_model->array_from_post(array('title'));
            ...
            $id = $this->cms_menu_model->save($data, $id);
