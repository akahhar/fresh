...
echo form_open(base_url('saas/gb/update_company_packages/' . $id), array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
                    ...
                    if (!empty($super_admin)) { ?>
                        <div class="form-group">
                            <label for="discount_type"
                                   class="control-label col-sm-3"><?= lang('select') . ' ' . lang('company') ?>
                                <span
                                        class="required">*</span></label>
                            <div class="col-sm-8">
                                <select name="companies_id" class="selectpicker m0"
                                        data-width="100%"
                                        data-none-selected-text="<?php echo lang('select') . ' ' . lang('company'); ?>"
