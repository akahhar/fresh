...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <?php } ?>
        <form method="post" action="<?php echo base_url() ?>saas/settings/update_email" class="form-horizontal">
            <div class="panel panel-custom">
                <header class="panel-heading "><?= lang('email_settings') ?></header>
                <div class="panel-body">
                    <input type="hidden" name="settings" value="<?= $load_setting ?>">
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('saas_company_email') ?> <span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="email" required="" class="form-control"
                                   value="<?= $this->config->item('saas_company_email') ?>" name="saas_company_email"
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('email_protocol') ?> <span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <select name="saas_protocol" required="" class="form-control">
                                <?php $prot = config_item('saas_protocol'); ?>
                                <option
                    ...
                    <div id="smtp_config">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" required="" class="form-control"
                                       value="<?= $this->config->item('saas_smtp_host') ?>" name="saas_smtp_host">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" required="" class="form-control"
                                       value="<?= $this->config->item('saas_smtp_user') ?>" name="saas_smtp_user">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <?php
                                $password = strlen(decrypt(config_item('saas_smtp_password')));
                                ?>
                                <input type="password" name="saas_smtp_password" placeholder="<?php
                                if (!empty($password)) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" required="" class="form-control"
                                       value="<?= $this->config->item('saas_smtp_port') ?>" name="saas_smtp_port">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= lang('email_encryption') ?></label>
                            <div class="col-lg-3">
                                <select name="saas_smtp_encryption" class="form-control">
                                    <?php $crypt = config_item('saas_smtp_encryption'); ?>
                                    <option
...
<div class="panel panel-custom">
    ...
    <div class="panel-body">
        <form method="post" action="<?php echo base_url() ?>saas/settings/sent_test_email" class="form-horizontal">
            <div class="form-group">
