...
<div class="row">
    <!-- Start Form test -->
    <div class="col-lg-12">
        <form method="post" action="<?php echo base_url() ?>saas/settings/save_server" class="form-horizontal">
            <div class="panel panel-custom">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('create_wildcard_subdomain') ?> <span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-5">
                            <div class="checkbox c-checkbox">
                                <label class="needsclick">
                                    <input type="checkbox" name="saas_server_wildcard" <?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            ...
                            <button type="submit" name="test_connection" value="test_connection"
                                    class="btn btn-sm btn-warning pull-right"><?= lang('test_connection') ?></button>
                        </div>
                    </div>
                </div>
            </div>
