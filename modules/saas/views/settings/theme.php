...
<div class="row">
    <!-- Start Form -->
    <div class="col-lg-12">
        <form action="<?php echo base_url() ?>saas/settings/save_theme" enctype="multipart/form-data"
            ...
            <div class="panel panel-custom">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="text" name="saas_website_name" class="form-control"
                                   value="<?= config_item('saas_website_name') ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('logo') ?></label>
                        <div class="col-lg-4">
                            <select name="saas_logo_or_icon" class="form-control">
                                <?php $logoicon = config_item('saas_logo_or_icon'); ?>
                                <option
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2 checkbox c-checkbox">
                            <label class="needsclick">
                                ...
                                $active_pre_loader = config_item('saas_active_pre_loader');
                                if (!empty($active_pre_loader) && $active_pre_loader == 1) {
                                    echo 'checked';
                                }
                                ?> value="1" name="saas_active_pre_loader">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2 checkbox c-checkbox">
                            <label class="needsclick">
                                ...
                                ?> value="1" name="saas_active_custom_color" id="active_custom_color">
                                <span class="fa fa-check"></span>
                            </label>
                        </div>
                    </div>
                    <div class="custom-color">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                <input id="navbar_logo_background" name="saas_navbar_logo_background" type="text"
                                       class="form-control colorpickerinput"
                                       value="<?= config_item('saas_navbar_logo_background'); ?>"/>
                            ...
                            <div class="col-md-3">
                                ...
                                <input id="top_bar_background" name="saas_top_bar_background" type="text"
                                       class="form-control colorpickerinput"
                                       value="<?= config_item('saas_top_bar_background'); ?>"/>
                            ...
                            <div class="col-md-3">
                                ...
                                <input id="top_bar_color" name="saas_top_bar_color" type="text"
                                       class="form-control colorpickerinput"
                                       value="<?= config_item('saas_top_bar_color'); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="sidebar-custom-color">
                                <div class="col-md-3">
                                    ...
                                    <input id="sidebar_background" name="saas_sidebar_background" type="text"
                                           class="form-control colorpickerinput"
                                           value="<?= config_item('saas_sidebar_background'); ?>"/>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="sidebar_color" name="saas_sidebar_color" type="text"
                                           class="form-control colorpickerinput"
                                           value="<?= config_item('saas_sidebar_color'); ?>"/>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="sidebar_active_background" name="saas_sidebar_active_background"
                                           type="text"
                                           class="form-control colorpickerinput"
                                           value="<?= config_item('saas_sidebar_active_background'); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="sidebar-custom-color">
                                <div class="col-md-3">
                                    ...
                                    <input id="sidebar_active_color" name="saas_sidebar_active_color" type="text"
                                           class="form-control colorpickerinput"
                                           value="<?= config_item('saas_sidebar_active_color'); ?>"/>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="submenu_open_background" name="saas_submenu_open_background" type="text"
                                           class="form-control colorpickerinput"
                                           value="<?= config_item('saas_submenu_open_background'); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="sidebar-custom-color">
                                <div class="col-md-3">
                                    ...
                                    <input id="active_background" name="saas_active_background" type="text"
                                           class="form-control colorpickerinput"
                                           value="<?= config_item('saas_active_background'); ?>"/>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="active_color" name="saas_active_color" type="text"
                                           class="form-control colorpickerinput"
                                           value="<?= config_item('saas_active_color'); ?>"/>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input id="body_background" name="saas_body_background" type="text"
                                           class="form-control colorpickerinput"
                                           value="<?= config_item('saas_body_background'); ?>"/>
                        ...
                        <div class="col-lg-7">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 210px;">
                                    <?php if (config_item('saas_company_logo') != '') : ?>
                                        <img src="<?php echo base_url() . config_item('saas_company_logo'); ?>">
                                    <?php else: ?>
                                ...
                                <div>
                                    <span class="btn btn-default btn-file">
                                        <span class="fileinput-new">
                                            <input type="file" name="saas_company_logo" value="upload"
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 210px;">
                                    <?php if (config_item('favicon') != '') : ?>
                                        <img src="<?php echo base_url() . config_item('saas_favicon'); ?>">
                                    <?php else: ?>
                                        <img src="<?= base_url('uploads/default_avatar.jpg') ?>"
                                             alt="Please Connect Your Internet">
                                    <?php endif; ?>
                                ...
                                <div>
                                    <span class="btn btn-default btn-file">
                                        <span class="fileinput-new">
                                            <input type="file" name="saas_favicon" value="upload"
                                                   data-buttonText="<?= lang('choose_file') ?>" id="myImg"/>
                                            <span class="fileinput-exists"><?= lang('change') ?></span>
                                        </span>
                                        <a href="#" class="btn btn-default fileinput-exists"
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 210px;height: 150px">
                                    ...
                                    <?php if (!empty($login_background[0]) && $login_background[0] == 'image') {
                                        ?>
                                        <img src="<?php echo base_url() . config_item('saas_login_background'); ?>">
                                    <?php } ?>
                                </div>
                                <div class="fileinput-preview fileinput-exists thumbnail" style="width: 210px;"></div>
                                <div>
                                    <span class="btn btn-default btn-file">
                                        <span class="fileinput-new">
                                            <input type="file" name="saas_login_background" value="upload"
                                                   data-buttonText="<?= lang('choose_file') ?>" id="myImg"/>
                                            <span class="fileinput-exists"><?= lang('change') ?></span>
                                        </span>
                                        <a href="#" class="btn btn-default fileinput-exists"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <select name="saas_login_position" class="form-control">
                                <?php $login_position = config_item('saas_login_position'); ?>
                                <option
                                ...
                                <div class="col mb">
                                    <div class="setting-color">
                                        <label data-load-css="<?php echo base_url(); ?>assets/css/bg-green.css">
                                            <input type="radio" name="saas_sidebar_theme"
                            ...
                            <div class="p">
                                <div class="clearfix">
                                    ...
                                    <div class="pull-right">
                                        <label class="switch">
                                            <input id="chk-float" type="checkbox" name="saas_layout-h" value="layout-h"
                                                   data-toggle-state="layout-h" <?= config_item('saas_layout-h') == 'layout-h' ? 'checked' : null ?>>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="clearfix">
                                    ...
                                    <div class="pull-right">
                                        <label class="switch">
                                            <input id="chk-fixed" name="saas_layout-fixed" value="layout-fixed"
                                                   type="checkbox"
                                                   data-toggle-state="layout-fixed" <?= config_item('saas_layout-fixed') == 'layout-fixed' ? 'checked' : null ?>>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="clearfix">
                                    ...
                                    <div class="pull-right">
                                        <label class="switch">
                                            <input id="chk-boxed" name="saas_layout-boxed" value="layout-boxed"
                                                   type="checkbox"
                                                   data-toggle-state="layout-boxed" <?= config_item('saas_layout-boxed') == 'layout-boxed' ? 'checked' : null ?>>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="clearfix">
                                    ...
                                    <div class="pull-right">
                                        <label class="switch">
                                            <input id="chk-collapsed" type="checkbox" name="saas_aside-collapsed"
                                                   value="aside-collapsed"
                                                   data-toggle-state="aside-collapsed" <?= config_item('saas_aside-collapsed') == 'aside-collapsed' ? 'checked' : null ?>>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="clearfix">
                                    ...
                                    <div class="pull-right">
                                        <label class="switch">
                                            <input id="chk-float" type="checkbox" name="saas_aside-float"
                                                   value="aside-float"
                                                   data-toggle-state="aside-float" <?= config_item('saas_aside-float') == 'aside-float' ? 'checked' : null ?>>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="clearfix">
                                    ...
                                    <div class="pull-right">
                                        <label class="switch">
                                            <input id="chk-hover" type="checkbox" name="saas_show-scrollbar"
                                                   value="show-scrollbar"
                                                   data-toggle-state="show-scrollbar" <?= config_item('saas_show-scrollbar') == 'show-scrollbar' ? 'checked' : null ?>>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="clearfix">
                                    ...
                                    <div class="pull-right">
                                        <label class="switch">
                                            <input id="chk-rtl"
                                                   name="saas_RTL" <?= config_item('saas_RTL') == 'on' ? 'checked' : null ?>
                                                   type="checkbox">
                                            <span></span>
                                        </label>
                                    </div>
