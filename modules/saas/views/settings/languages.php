                    ...
                    if (!empty($active_language)) :
                        foreach ($active_language as $v_language) :
                            ...
                            <tr>
                                ...
                                <td class=""><a
                                            href="<?= base_url() ?>saas/settings/languages/<?= $v_language->name ?>"><?= ucwords(str_replace("_", " ", $v_language->name)) ?></a>
                                </td>
                                <td>
                                    <div class="progress">
                                        <?php
                                ...
                                <td class="">
                                    <?php if (!empty($edited)) { ?> <a data-toggle="tooltip"
                                                                       ...
                                                                       href="<?= base_url() ?>saas/settings/languages_status/<?= $v_language->name ?>/<?= ($v_language->active == 1 ? 0 : 1) ?>"><i
                                                class="fa fa-check"></i></a>
                                    <a data-toggle="tooltip" title="<?= lang('edit') ?>" class="btn btn-xs btn-primary"
                                       href="<?= base_url() ?>saas/settings/languages/<?= $v_language->name ?>"><i
            ...
            <table id="table-translations-files" class="table table-striped b-t b-light AppendDataTables">
                ...
                <?php foreach ($language_files as $file => $altpath) :
                    ...
                    <tr>
                        ...
                        <td class=""><a
                                    href="<?= base_url() ?>saas/settings/edit_language/<?= $language ?>/<?= $shortfile ?>"><?= $fn ?></a>
                        </td>
                        <td>
                            <div class="progress">
                                <?php $bar = 'danger';
                        ...
                        <td class="">
                            <a class="btn btn-xs btn-default"
                               href="<?= base_url() ?>saas/settings/edit_language/<?= $language ?>/<?= $shortfile ?>"><i
...
<?php elseif (!empty($current_languages)) : ?>
    ...
    echo form_open_multipart('saas/settings/set_translations/' . $current_languages . '/' . $active_language_files, $attributes); ?>
    ...
    <section class="panel panel-custom">
        <header class="panel-heading font-bold"><i class="fa fa-cogs"></i>
            ...
            <?= lang('translations') ?> | <a style="color: red"
                                             href="<?= base_url() ?>saas/settings/languages/<?= $current_languages ?>"><?= ucwords(str_replace("_", " ", $current_languages)) ?></a>
