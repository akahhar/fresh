...
<header class="topnavbar-wrapper">
    ...
    <nav role="navigation" class="navbar topnavbar">
        <!-- START navbar header-->
        <?php $display = config_item('saas_logo_or_icon'); ?>
        <div class="navbar-header">
            <?php if ($display == 'logo' || $display == 'logo_title') { ?>
                <a href="#" class="navbar-brand">
                    <div class="brand-logo">
                        <img style="width: 100px;max-height: 42px;"
                             src="<?= base_url() . config_item('saas_company_logo') ?>" alt="App Logo"
                ...
                <li class="hidden-xs">
                    <a href="" class="text-center" style="vertical-align: middle;font-size: 20px"><?php
                        if ($display == 'logo_title' || $display == 'icon_title') {
                            if (config_item('saas_website_name') == '') {
                                echo config_item('saas_company_name');
                            } else {
                                echo config_item('saas_website_name');
                            }
                        }
                        ?></a>
                </li>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu animated zoomIn">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?= base_url() ?>saas/settings/update_profile"
