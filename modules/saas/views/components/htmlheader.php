...
<head>
    ...
    <style>
        <?php
    if (!empty(config_item('saas_sidebar_font_size'))){
        ?>
        .sidebar .nav > li > a,
        .sidebar .nav > li > .nav-item {
            font-size: <?= config_item('saas_sidebar_font_size').'px !important'?>;
        }

        <?php
    }
    if (!empty(config_item('saas_body_font_size'))){
        ?>
        body {
            font-size: <?= config_item('saas_body_font_size').'px !important'?>;
        }
