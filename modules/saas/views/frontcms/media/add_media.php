<form action="<?= base_url() ?>saas/frontcms/media/save_media" enctype="multipart/form-data" method="post">
    <div class="panel panel-custom" data-collapsed="0">
        <div class="panel-heading">
            <div class="panel-title"><?= lang('add') . ' ' . lang('media') ?></div>
        </div>

        <div class="modal-body">
            <div class="form-group clearfix">
                <label for="" class="control-label"><?= lang('upload_your_file'); ?></label>
            ...
            <div class="form-group">
                <label for="" class="control-label"><?= lang('upload_youtube_video'); ?></label>
