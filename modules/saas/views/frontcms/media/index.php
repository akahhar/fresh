<?= message_box('success'); ?>
<?= message_box('error');
$created = can_action_by_label('media', 'created');
$deleted = can_action_by_label('media', 'deleted');
    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $('#confirm-delete').on('show.bs.modal', function (e) {
                ...
                $('.del_modal_title').html('<?= lang('delete_confirmation') ?>');
                $('.del_modal_body').html('<?= lang('delete_conform') ?>');
            });
...
<div class="modal fade" id="detail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="panel panel-custom fullshadow">
            <div class="panel-heading">
                <span id="modal_media_name"></span> - <?= lang('details') ?>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 smcomment-title pt-2">
                        ...
                        <h4 class="mb-0"><?= lang('media_type') ?></h4>
                        <p id="modal_media_type"></p>
                        <h4 class="mb-0"><?= lang('media_path') ?></h4>
                        <p id="modal_media_path"></p>
                        <h4 class="mb-0"><?= lang('media_size') ?></h4>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn_delete btn-danger"
                   data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.."><?= lang('delete') ?></a>
            </div>
        </div>
    </div>
</div>