...
<div class="row">
    <div class="col-md-7">
        <div class="panel panel-custom" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                ?>
                <form action="<?php echo base_url(); ?>saas/frontcms/menus/add_menu_item/<?php if (!empty($menu_info)) {
                    echo $slug;
                } ?>/<?php if (!empty($menu_slug)) {
                    echo $menu_slug;
                } ?>" method="post" accept-charset="utf-8" data-parsley-validate novalidate>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?= lang('menu') . ' ' . lang('title'); ?></label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('external_url'); ?></label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('external_url_address'); ?></label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('open_in_new_tab'); ?></label>
                        <div class="material-switch">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('mpage'); ?></label>
    ...
    <div class="col-md-5">
        <div class="panel panel-custom" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title">
                    <?= lang('menu') . ' ' . lang('item') . ' ' . lang('list') ?>
                </div>
            </div>

            <div class="panel-body">
                <form action="<?php echo site_url('saas/frontcms/menus/update') ?>" method="post"
                                        ...
                                        <div>
                                            ...
                                            <span class="pull-right">
                                                <a href="<?php echo site_url('saas/frontcms/menus/add_menu_item/' . $m_slug . "/" . $menu['slug']) ?>"
                                                   class="btn btn-xs" title="<?php echo lang('edit'); ?>"><i
                                                            class="fa fa-pencil"></i></a>
                                                <a href="#" class="btn btn-xs" title="<?php echo lang('delete'); ?>"
...
<script type="text/javascript"
        src="<?= module_dirURL(SaaS_MODULE, 'assets/js/jquery.mjs.nestedSortable.js') ?>"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?php echo lang('confirmation'); ?></h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger btn-ok"><?php echo lang('delete'); ?></a>
            </div>
        </div>
    </div>
</div>