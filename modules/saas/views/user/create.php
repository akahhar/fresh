        ...
        <div class="tab-content bg-white">
            ...
            <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="new">
                <form role="form" data-parsley-validate="" novalidate="" id="userform" enctype="multipart/form-data"
                      action="<?php echo base_url(); ?>saas/super_admin/save_user/<?= $user_id ?>" method="post"
                    ...
                    <?php if (empty($login_info->user_id)) { ?>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><strong><?= lang('confirm_password') ?> </strong><span
                                        class="text-danger">*</span></label>
                            <div class="col-sm-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="email" id="check_email_addrees"
                                   placeholder="<?= lang('eg') ?> <?= lang('user_placeholder_email') ?>" name="email"
                                   value="<?php
                                   if (!empty($login_info)) {
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="language" class="form-control selectpicker" style="width: 100%">
