...
<div class="panel panel-custom">
    ...
    <?php if (!empty($created) || !empty($edited)) { ?>
        <?php echo form_open(base_url('admin/deals/update_category'), array('id' => 'group_modal', 'class' => 'form-horizontal')); ?>
...
<script type="text/javascript">
    $(document).on("submit", "form", function (event) {
        ...
        if (form.attr('action') == '<?= base_url('admin/deals/update_category')?>') {
