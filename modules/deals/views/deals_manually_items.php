<div class="panel panel-custom">
    ...
    <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" method="post"
        ...
        <div class="col-sm-7">
            ...
            <div class="form-group">
                <label class="col-lg-3 col-md-3 col-sm-3 control-label"><?= lang('quantity') ?> <span
                            class="text-danger">*</span></label>
                <div class="col-lg-9">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <input type="text" class="form-control"
                           ...
                           placeholder="<?= lang('unit_type_example') ?>" name="unit">
                </div>
            </div>
            ...
            <div class="form-group mt-lg">
                ...
                <div class="col-lg-9">
                    <div class="btn-bottom-toolbar">
                        ...
                        if (!empty($items_info)) { ?>
                            <button type="submit"
                                    class="btn btn-sm btn-primary itemManualy"><?= lang('updates') ?></button>
