...
<table class="items" width="100%">
    ...
    foreach ($permission_users as $v_users) {
        ...
        $total_u_comments = count($this->db->where(array('module_field_id' => $task_details->task_id, 'module' => 'tasks'))->get('tbl_task_comment')->result());
        $total_u_attachment = count($this->db->where(array('module_field_id' => $task_details->task_id, 'module' => 'tasks'))->get('tbl_attachments')->result());
