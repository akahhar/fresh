...
<head>
    ...
    <title>ZiscoERP - Powerfull HR,Accounting,CRM System</title>
    ...
    <div class="container" style="width:80%">
        <section class="panel panel-default bg-white m-t-lg">
            <header class="panel-heading text-center">
                <strong>Thank You for Purchasing ZiscoERP - Powerfull HR,Accounting,CRM System</strong>
            </header>
                    ...
                    <div class="step-content clearfix">
                        ...
                        if ($step == 1) { ?>
                            <div class="step-pane <?= $step1 ?>" id="step1">
                                ...
                                ?>
                                <?php if ($error == true) {
                                    echo '<div class="text-center alert alert-danger">You need to fix the requirements in order to continue installing ZiscoERP - Powerfull HR,Accounting,CRM System</div>';
                                } else {
                        ...
                        <?php } ?>
                        <?php if ($step == 2) { ?>
                            <div class="step-pane <?= $step2 ?>" id="step3">
                        ...
                        <?php if ($step == 4) { ?>
                            <div class="step-pane <?= $step4 ?>" id="step4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <select name="timezone" class="form-control select_box" style="width: 100%"
                                                required>
