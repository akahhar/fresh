    ...
    this.not('.' + treeclass).each(function () {
        ...
        var c = 'class', mobile = fm.UA.Mobile,
            ...
            replace = {
                ...
                title: function (dir) {
                    return opts.attrTitle ? (' title="' + fm.escape(fm.path(dir.hash, true) || dir.i18 || dir.name) + '"') : '';
                },
                root: function (dir) {
                    var cls = '';
        ...
        fm.open(function (e) {
            ...
            .change(function (e) {
                ...
                var dirs = filter(e.data.changed, true),
                    ...
                    tgts = $(),
                    changed = {},
                    dir, phash, node, tmp, realParent, reqParent, realSibling, reqSibling, isExpanded, isLoaded, parent,
                    subdirs;
